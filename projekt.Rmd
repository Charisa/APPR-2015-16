...
Za boljšo predstavo, kako se razlikujejo indeksi razvitih držav si poglejmo naslednji diagram.
...
Pri državah z nizko vrednostjo HDI (Human Development Index) so indeksi, ki se jim z večjo vrednostjo veča kvaliteta, manjši in obratno.
