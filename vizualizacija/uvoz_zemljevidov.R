uvoz_zemljevidov <- function(tabela, indeks, ime_zemljevida, barva = "RdPu"){
  ...
  # Indeks: ime stolpca v tabeli
  # Tabela: leto_2015
  # ime_zemljevida: "zemljevid_indeks"
  
  ime <- joinCountryData2Map(tabela, joinCode = "NAME", nameJoinColumn = "Country", 
                             mapResolution = "coarse")
  classInt <- classIntervals(ime[[indeks]], 7)
  
  mapParams <- mapCountryData(ime, nameColumnToPlot = indeks, catMethod = "fixedWidth",
